...
- **[FlashFlow](https://github.com/nnt-git13/flashflow)** — GPU-optimized Transformer inference runtime (CUDA + Triton)
...
FPGA RTL design (SystemVerilog, AXI, BRAM), GPU kernel optimization (CUDA, Triton), compiler internals (FX lowering, IR transforms), quant finance modeling (Monte-Carlo, Black-Scholes), advanced systems (OS, scheduling, memory models)

### 💬 Ask me about  
GPU kernel fusion, memory tiling, attention kernels, RISC-V pipeline design & ISA extensions, Monte-Carlo engines, ASIC/FPGA flows, Vivado, Verilator, PyTorch FX → fused kernels, quant engineering
